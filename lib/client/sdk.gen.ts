 ...
 * Get Adaptive Plan
 */
export const getAdaptivePlanApiTrainingPlanGet = <ThrowOnError extends boolean = false>(options?: Options<GetAdaptivePlanApiTrainingPlanGetData, ThrowOnError>) => (options?.client ?? client).get<GetAdaptivePlanApiTrainingPlanGetResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const getNextTaskRecommendationApiTrainingRecommendedTaskGet = <ThrowOnError extends boolean = false>(options?: Options<GetNextTaskRecommendationApiTrainingRecommendedTaskGetData, ThrowOnError>) => (options?.client ?? client).get<GetNextTaskRecommendationApiTrainingRecommendedTaskGetResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * Get Theme Analysis
 */
export const getThemeAnalysisApiTrainingThemeThemeGet = <ThrowOnError extends boolean = false>(options: Options<GetThemeAnalysisApiTrainingThemeThemeGetData, ThrowOnError>) => (options.client ?? client).get<GetThemeAnalysisApiTrainingThemeThemeGetResponses, GetThemeAnalysisApiTrainingThemeThemeGetErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
